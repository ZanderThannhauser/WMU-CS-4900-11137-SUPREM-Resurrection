 ...
 *									*
 ************************************************************************/
double Gediff_coeff(temp, new, equil, noni, idf, vdf, iprt, vprt)
 ...
 *									*
 ************************************************************************/
Geactive( simple, nn, temp, conc, act, equil, noni )
int simple;
int nn;
float temp;
double **conc;
 ...
 *									*
 ************************************************************************/
int germanium(char *par, int param)
{ 
    int mat;
    int mat2 = -1;
    register int i,j;
    ...
    for (; i <= j ; i++) {
	if ( i == 0 )	CLEAR_FLAGS(iGe, IMPLANTED_IMP);
	else		SET_FLAGS(iGe, IMPLANTED_IMP);
