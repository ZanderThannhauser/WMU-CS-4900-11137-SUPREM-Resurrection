...
{
       0,    85,    85,    86,    90,    98,   102,   107,   115,   125,
     133,   141,   149,   161,   165,   173,   177,   181,   186,   193,
     198,   204,   209,   216,   220,   226,   232,   238,   244,   250,
     256,   262,   268,   274,   280,   286,   294,   300,   306
};
#endif
...
{
  "$end", "error", "$undefined", "CARD", "BG_GRP", "END_GRP", "PARTYPE",
  "EOL", "BOOLSTART", "GRT", "LES", "GRTE", "LESE", "OR", "AND", "EQU",
  "NOTEQU", "NOT", "PLUS", "TIMES", "RCONST", "STRING", "INTEGER", "NUMB",
  "NAME", "UNITS", "ERR_MSG", "COMMENT", "PARNAME", "'='", "'('", "')'",
  "$accept", "keyfile", "parameter", "identifier", "id", "deflt",
  "err_msg", "boolean", "bexp", "term", YY_NULLPTR
};
#endif
