...
struct command_table command[NUMCMD] = {
    {"echo", echo, 0}, {"man", man, 0}, {"initialize", initialize, 0},
    {"cpulog", cpu, 0}, {"plot.2d", plot_2d, 0}, {"option", option, 0},
    {"method", method, 0}, {"diffuse", diffuse, 0}, {"implant", implant, 0},
    {"select", sel_var, 0}, {"contour", contour, 0}, {"plot.1d", plot_1d, 0},
    {"print.1d", print_1d, 0}, {"vacancy", vacancy, 0},
    {"interstitial", interstitial, 0}, {"antimony", antimony, 0},
    {"arsenic", arsenic, 0}, {"boron", boron, 0}, {"oxide", coeffox, 0},
    {"phosphorus", phosphorus, 0}, {"region", rregion, 0},
    {"boundary", redge, 0}, {"line", rline, 0}, {"structure", structure, 0},
    {"deposit", user_deposit, 0}, {"etch", user_etch, 0}, {"gold", gold, 0},
    {"stress", stress_analysis, 0}, {"material", c_mater, 0},
    {"cesium", cesium, 0}, {"pause", uPause, 0}, {"trap", trap, 0},
    {"printf", user_print, 0}, {"profile", profile, 0}, {"mode", mode_cmd, 0},
    {"device", device, 0}, {"beryllium", beryllium, 0},
    {"magnesium", magnesium, 0}, {"selenium", selenium, 0},
    {"isilicon", silicon, 0}, {"tin", tin, 0}, {"germanium", germanium, 0},
    {"zinc", zinc, 0}, {"carbon", carbon, 0}, {"generic", generic, 0},
    {"", NULL, 45}, {"", NULL, 46}, {"", NULL, 47}, {"", NULL, 48},
    {"", NULL, 49}};
