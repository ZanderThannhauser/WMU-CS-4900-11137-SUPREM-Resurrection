...
void get_Cstar(int imp, int nv, float temp, double *noni, double *equil,
    ...
    for (i = 0; i < nv; i++) {
        ...
        den = Dfrac[f][mat][CN] + Dfrac[f][mat][CM] + Dfrac[f][mat][CDM] +
              Dfrac[f][mat][CTM] + Dfrac[f][mat][CP] + Dfrac[f][mat][CDP] +
              Dfrac[f][mat][CTP];

        /*compute the concentration of these guys*/
        num = Dfrac[f][mat][CN] +
              (Dfrac[f][mat][CM] +
               (Dfrac[f][mat][CDM] + Dfrac[f][mat][CTM] * c) * c) *
                  c +
              (Dfrac[f][mat][CP] +
               (Dfrac[f][mat][CDP] + Dfrac[f][mat][CTP] / c) / c) /
                  c;
        ...
        num = (Dfrac[f][mat][CM] +
              ...
              (Dfrac[f][mat][CP] +
               (2 * Dfrac[f][mat][CDP] + 3 * Dfrac[f][mat][CTP] / c) / c) /
                  (c * c);
