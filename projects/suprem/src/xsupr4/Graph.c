...
/* ARGSUSED */
void unzoom(Widget widget, XtPointer client_data, XtPointer call_data)
...
/* ARGSUSED */
void do_cn(Widget widget, XtPointer client_data, XtPointer call_data)
...
/* ARGSUSED */
void do_pr(Widget widget, XtPointer client_data, XtPointer call_data)
// XtPointer client_data;   /* cast to bigBitmap */
// XtPointer call_data;	/* unused */
{
	#if 0
